...
export function Credential({ data, onChangeAvatar, onExpandQRCode }: Props) {
  ...
  return (
    ...
    >
      ...
      <View className="bg-black/20 self-stretch items-center pb-6 border border-white-10 mx-3 rounded-2xl -mt-6">
        <ImageBackground
        ...
        {data.image ? (
          <TouchableOpacity activeOpacity={0.7} onPressOut={onChangeAvatar}>
            <Image
